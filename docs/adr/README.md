...
| 0011 | Tratamento de histórico fechado | F5 — reabertura implementada com permissão única (`periods:reopen`), motivo obrigatório e bloqueio de fechamento já pago; a dupla aprovação segue em aberto |
