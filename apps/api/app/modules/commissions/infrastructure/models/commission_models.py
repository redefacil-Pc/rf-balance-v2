...
class CommissionSettlementModel(Base):
    ...
    manual_discount_amount: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False)
    reversal_discount_amount: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False)
    reversal_carryover_amount: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False)
...
class CommissionPeriodModel(Base):
    ...
    reopen_requested_at: Mapped[datetime | None] = mapped_column(UtcDateTime, nullable=True)
    reopen_requested_by: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
