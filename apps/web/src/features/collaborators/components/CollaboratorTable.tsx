...
import { IconPencil, IconPlayerPlay, IconTrash, IconUserCog } from '@tabler/icons-react';
...
export function CollaboratorTable({ colaboradores, podeVerPii, podeEditar, onEditar, onInativar, onFuncoes, onAcesso }: Props) {
